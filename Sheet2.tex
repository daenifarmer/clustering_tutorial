...
% ---- 1 ----
\item Implementieren Sie den \textbf{Hoshen-Kopelman-Algorithmus} zur Cluster"=Beschriftung.

\textbf{Bonusaufgabe:} Implementieren Sie \texttt{UnionFind} selbst, alternativ hilft hier bspw. Networkx.
